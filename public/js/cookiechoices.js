...
(function (window) {
  ...
  var cookieChoices = (function () {
    ...
    function _createHeaderElement(cookieText, dismissText, linkText, linkHref, paramText) {
      var butterBarStyles = 'position:fixed;width:100%;background-color: #ECD300; color: rgb(0, 0, 0); ' +
    ...
    function _createInformationLink(dismissText) {
      ...
      dismissLink.style.color = '#EF4136';
      return dismissLink;
    }
    ...
    function _createParameterLink(parameterText) {
      ...
      parameterLink.style.color = '#EF4136';
